...
class HLoopOptimization : public HOptimization {
 ...
 private:
  ...
  // Returns whether transformation happened. 'do_opt' determines whether the optimization should
  // be actually applied.
  bool TryFullUnrolling(LoopAnalysisInfo* analysis_info, bool do_opt = true);
