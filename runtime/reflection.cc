...
ALWAYS_INLINE
static bool InvokeMethodCheckArgs(ArtMethod* np_method,
...
ALWAYS_INLINE
static bool InvokeMethodImpl(const ScopedObjectAccessAlreadyRunnable& soa,
                             ArtMethod* m,
                             ArtMethod* np_method,
                             ObjPtr<mirror::Object> receiver,
                             ObjPtr<mirror::ObjectArray<mirror::Object>> objects,
...
jobject InvokeMethod(const ScopedObjectAccessAlreadyRunnable& soa, jobject javaMethod,
  ...
  if (!InvokeMethodCheckArgs(np_method, objects)) {
    return nullptr;
  }
